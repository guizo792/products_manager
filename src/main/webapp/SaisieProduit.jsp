...
<body>
	...
	<div class="container col-md-8 col-md-offset-2 col-xs-12">
		<div class="card ">
			<div class="card-header bg-primary mb-3 text-center text-white">Adding a product</div>
				...
				<form action="SaveProduit.php" method="post">
					...
					<div class="container">
						<div class="row">
							...
							<div class="col text-center">
									<a href="/products_manager/index.php" class="text-white btn btn-warning" >Back home</a>
							</div>
						</div>
					</div>
				</form>
